...
def guest_manage(request):
    ...
    return render(request, "guest_manage.html", {"user": username, "guests": contacts, 'weather': weater})
...
def weater():
    r = requests.get(
        'https://free-api.heweather.com/s6/weather/forecast?location=北京&key=4e6ea60db7634f3ba31616c733500301')
    a = r.json()
    dictionary = Dict(a)
